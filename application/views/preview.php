<html>
    <body style="width: 1024">
        ...
        <div style="float: left;width: 100%">
            ...
            <span class="card-info" style="top:643px"><?php echo $_REQUEST['tel'] ?></span>
            <span class="card-info" style="top:654px"><?php echo $_REQUEST['direct'] ?></span>
            <span class="card-info" style="top:664px"><?php echo $_REQUEST['fax'] ?></span>
            <span class="card-info" style="top:670px"><?php echo $_REQUEST['email'] ?></span>
